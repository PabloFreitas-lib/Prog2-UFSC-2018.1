#ifndef LISTA_INTERFACE_H_
#define LISTA_INTERFACE_H_
 ...
 /*
 void move(int a,int b,lista_t *box);
 void move_topo(int a,int b,lista_t *box);
 void emp(int a ,int b,lista_t *box);
 void emp_topo(int a,int b,lista_t *box);
 void saida(lista_t *box,int n);
 void retorna(lista_t *box,int p);*/
